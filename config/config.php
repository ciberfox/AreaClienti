...
define("COOKIE_DOMAIN", '.mydomain.com'); // to be replaced by '.mydomain.com'
define("COOKIE_SECRET_KEY", "1gp@T45646sfpM4545-92s");
 ...
 */
 ...
 define("EMAIL_SMTP_USERNAME", "no-reply@no.it");
 define("EMAIL_SMTP_PASSWORD", "toor");
 ...
 */
define("EMAIL_PASSWORDRESET_FROM", "no-reply@no.it");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Area Cleinti");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset");
define("EMAIL_PASSWORDRESET_CONTENT", "Fai click sul link per resettare la password:");

/**
 * Configuration for: verification email data
 */
define("EMAIL_VERIFICATION_FROM", "no-reply@no.it");
define("EMAIL_VERIFICATION_FROM_NAME", "Area Cleinti");
define("EMAIL_VERIFICATION_SUBJECT", "Attivazione account");
define("EMAIL_VERIFICATION_CONTENT", "Fai click sul link per attivare il tuo account:");
