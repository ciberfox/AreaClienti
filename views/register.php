...
<legend><?php echo WORDING_REGISTER; ?></legend>
	<form method="post" action="?register">
        ...
        <label for="codice_contabile"><?php echo WORDING_CODICE_CONTABILE; ?></label>
		<input id="codice_contabile" type="text" pattern="[0-9]{3}[.]{1}[0-9]{5}" name="codice_contabile" value="<?php echo (isset($_POST['codice_contabile']) ? $_POST['codice_contabile'] : ''); ?>" required autofocus />
