...
define("MESSAGE_USERNAME_BAD_LENGTH", "Il nome utente non può essere più corto di 2 o più lungo di 64 caratteri");
define("MESSAGE_USERNAME_CHANGE_FAILED", "Spiacente, la variazione del tuo nome utente non è riuscita.");
define("MESSAGE_USERNAME_CHANGED_SUCCESSFULLY", "Il tuo nome utente è stato cambiato. Il nuovo nome utente è ");
define("MESSAGE_USERNAME_EMPTY", "Nome utente omesso");
define("MESSAGE_USERNAME_EXISTS", "Spiacente, nome utente già utilizzato. Prego, scegline un'altro.");
define("MESSAGE_USERNAME_INVALID", "Il nome utente non è conforme ai requisiti: sono ammesse solo lettere a-Z e numeri, da 2 a 64 caratteri");
define("MESSAGE_USERNAME_SAME_LIKE_OLD_ONE", "Spiacente, il nome utente indicato è lo stesso che stai usando. Prego, scegline un'altro.");
...
define("WORDING_CHANGE_USERNAME", "Cambia nome utente");
...
define("WORDING_NEW_USERNAME", "Nuovo nome utente (nome utente non può essere omesso e deve utilizzare i caratteri azAZ09 ed essere lungo 2-64 caratteri)");
...
define("WORDING_REGISTRATION_USERNAME", "Nome utente (solo lettere e numeri, da 2 a 64 caratteri)");
define("WORDING_REMEMBER_ME", "Mantienimi connesso");
define("WORDING_REQUEST_PASSWORD_RESET", "Richiedi il reset della password.<br/>Inserisci il tuo nome utente o la tua email, e riceverai una mail con le istruzioni:");
...
define("WORDING_CODICE_CONTABILE", "Codice Cliente 501.0000000");
